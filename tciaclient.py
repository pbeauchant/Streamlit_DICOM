...
class TCIAClient:
    ...
    GET_getSOPInstanceUIDs = 'getSOPInstanceUIDs'
    ...
    def get_getSOPInstanceUIDs(self,SeriesInstanceUID = None , outputFormat = "json" ):
        serviceUrl = self.baseUrl + "/query/" + self.GET_getSOPInstanceUIDs
